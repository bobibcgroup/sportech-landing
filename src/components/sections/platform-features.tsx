...
const FEATURES = [
  { patented: true, title: "Player Camera", body: "Jersey-mounted POV. Fans choose their player and watch live. Patented, rare, and unlike anything else in sport.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg> },
  { title: "Live Stream Gifting", body: "TikTok-style gifting on live match streams. Fans send virtual gifts in real time — every gift is a revenue event.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12v-2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2"/><rect x="2" y="12" width="20" height="8" rx="2"/><path d="M12 2a4 4 0 0 1 4 4H8a4 4 0 0 1 4-4z"/><line x1="12" y1="12" x2="12" y2="20"/></svg> },
