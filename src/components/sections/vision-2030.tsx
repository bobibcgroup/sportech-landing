      ...
      <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="geo" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            <polygon points="40,4 76,20 76,60 40,76 4,60 4,20" fill="none" stroke="var(--color-primary)" strokeWidth="0.8" />
            <polygon points="40,14 66,26 66,54 40,66 14,54 14,26" fill="none" stroke="var(--color-primary)" strokeWidth="0.5" />
            <line x1="40" y1="4" x2="40" y2="76" stroke="var(--color-primary)" strokeWidth="0.3" />
            <line x1="4" y1="40" x2="76" y2="40" stroke="var(--color-primary)" strokeWidth="0.3" />
          </pattern>
        </defs>
  ...
  return (
    <section ref={sectionRef} className="bg-canvas py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          SAUDI TECH.{" "}
          <span style={{ color: "var(--color-primary)" }}>BUILT HERE, DEPLOYED GLOBALLY.</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PILLARS.map(({ title, body, icon }, i) => (
            <motion.div
              ...
              style={{ background: "rgba(12,12,12,0.5)", borderColor: "rgba(var(--color-primary-rgb),0.08)" }}
            >
